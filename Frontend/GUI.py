...
class ChatSection(QWidget):
    def __init__(self):
        ...
        movie = QMovie(GraphicsDirectoryPath('Roger.gif'))
        max_gif_size_W = 50
        max_gif_size_H = 50
    ...
    def toggle_icon(self, event=None):
        if self.toggled:
            ...
            MicButtonClosed()
        print("Mic toggled: ", GetMicrophoneStatus())
...
class InitialScreen(QWidget):
        def __init__(self, parent = None):
            ...
            max_gif_size_H = int((screen_width / 16 * 9)/2)
            movie.setScaledSize(QSize(int(screen_width/2), max_gif_size_H))
